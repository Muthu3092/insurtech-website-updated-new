          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-12 h-12 rounded-2xl bg-lime flex items-center justify-center">
                <span className="text-ink font-display text-3xl font-semibold leading-none">a</span>
              </div>
              <div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4 text-sm text-cream/70">
              <li className="flex gap-3">
                ...
                <span>Level 12, Menara KL, Jalan Punchak, 50250 Kuala Lumpur, Malaysia</span>
              </li>
              <li className="flex gap-3">
                <Phone className="w-4 h-4 mt-0.5 text-lime shrink-0" />
                <a href="tel:+60123456789" className="hover:text-lime">+60 12 345 6789</a>
              </li>
              <li className="flex gap-3">
